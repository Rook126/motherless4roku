      ...
      for each element in xml.getChildElements()
        if element.getChildElements() <> invalid
          ...
          for each child in element.getchildElements()
            ...
            else if child.getname() = "thumbnail"
              contentNode.hdposterurl = child.getText()
              contentNode.sdposterurl = child.getText()
            ...
            ''  contentnode.contentQuality = child.gettext()
              ...
              for each item in child.getchildElements()
                ...
                else if item.getname() = "seconds"
                  contentnode.shortdescriptionline2 = item.gettext()
                else if item.getname() = "mediatype"
                  contentnode.streamFormat = item.gettext()
                else
                  print "WHY AM I HERE: " ; item.getName() ; item.getText()
                end if
              end for
            else if child.getname() = "codename"
              codename = child.getText()
              contentNode.url = "http://cdn4.videos.motherlessmedia.com/videos/"+codename+".mp4"
            else if child.getname() = "tags"
